...
@Component({
      ...
      <div class="container">
        ...
        <div class="stats-grid">
          <div class="impact-card">
            <div class="impact-icon" style="background: rgba(31,60,136,0.08); color: var(--primary);">📋</div>
          ...
          <div class="impact-card">
            <div class="impact-icon" style="background: rgba(42,157,143,0.08); color: var(--secondary);">🏢</div>
          ...
          <div class="impact-card">
            <div class="impact-icon" style="background: rgba(233,196,106,0.15); color: #b45309;">⚡</div>
          ...
          <div class="impact-card">
            <div class="impact-icon" style="background: rgba(69,123,157,0.1); color: var(--info);">⏱️</div>
          ...
          <div class="impact-card">
            <div class="impact-icon" style="background: rgba(230,57,70,0.08); color: var(--danger);">⭐</div>
      ...
      <div class="container">
        ...
        <div class="dept-grid">
          <div *ngFor="let dept of departments" class="dept-card">
            ...
            <div class="dept-count">{{ dept.count }}+ resolved</div>
          </div>
        </div>
      </div>
    </section>
  ...
  styles: [`
    ...
    .about-section {
      ...
      .about-image {
        ...
        .about-image-badge {
          ...
          .badge-number { font-size: 1.5rem; font-weight: 800; }
      ...
      .about-content {
        ...
        .about-highlights {
          ...
          .highlight-item {
            ...
            strong { display: block; font-size: 0.9rem; color: var(--text-primary); margin-bottom: 2px; }
            p { font-size: 0.82rem; margin: 0; color: var(--text-muted); }
          }
        }
      }
    }
    ...
    .dept-section {
      ...
      .dept-card {
        ...
        &:hover {
          ...
          .dept-name { color: var(--primary); }
        }

        .dept-icon { font-size: 2rem; margin-bottom: 8px; }
    ...
    .testimonials-section {
      ...
      .section-header {
        h2, p { color: rgba(255,255,255,0.9); }
        .overline { background: rgba(255,255,255,0.1); color: rgba(255,255,255,0.8); }
      ...
      .testimonial-card {
        ...
        .testimonial-author {
          ...
          .author-name { font-size: 0.9rem; font-weight: 700; color: white; }
    ...
    .cta-section {
      ...
      .cta-bg {
        ...
        .cta-overlay {
          position: absolute; inset: 0;
          background: linear-gradient(135deg, rgba(13,27,62,0.95), rgba(31,60,136,0.9));
        }
      }
